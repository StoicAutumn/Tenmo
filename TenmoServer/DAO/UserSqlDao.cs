...
namespace TenmoServer.DAO
{
    public class UserSqlDao : IUserDao
    {
        ...
        //Returns usernames and Ids exceply who is currently logged in
        public IList<User> GetOtherUsernamesAndIds(int userId)
        {
            IList<User> users = new List<User>();
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        //if userID deoesn't equal given userID DON'T add to list
